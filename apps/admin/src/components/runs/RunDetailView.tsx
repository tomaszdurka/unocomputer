  ...
  return (
    <div className="relative pl-8">
      ...
      >
        ...
        {open && payloadObj ? (
          <pre className="mt-3 overflow-x-auto rounded-lg bg-gray-100 dark:bg-neutral-800 p-3 text-xs">
...
export default function RunDetailView({ run }: { run: Run }) {
          ...
          {run.outputSchema ? (
            <>
              ...
              <div>
                ...
                <pre className="overflow-x-auto rounded-lg bg-gray-100 dark:bg-neutral-800 p-3 text-xs">
