...
export function Pagination({ page, pageSize, total, onPageChange }) {
    ...
    const buttonClasses = 'rounded-lg border border-gray-300 px-3 py-1.5 text-sm text-gray-700 ' +
    ...
    return (<div className="flex items-center justify-between">
      ...
      <div className="flex gap-2">
        ...
        <button type="button" onClick={() => onPageChange(page + 1)} disabled={page >= lastPage} className={buttonClasses}>
          Next
        </button>
      </div>
    </div>);
